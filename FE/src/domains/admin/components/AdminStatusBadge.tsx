...
const MAP: Record<string, string> = {
  ...
  OPEN: 'bg-success/22 text-neutral-800 border border-success/45',
  FULL: 'bg-warning/22 text-neutral-900 border border-warning/40',
  EXPIRED: 'bg-[var(--color-charcoal)] text-neutral-800 border border-[var(--color-border)]',
  FREE: 'bg-[var(--color-charcoal)] text-neutral-800 border border-[var(--color-border)]',
  PRO: 'bg-accent/24 text-neutral-900 dark:text-accent border border-accent/45',
  PLUS: 'bg-primary/20 text-neutral-900 border border-primary/35',
  TEAM: 'bg-[var(--color-focus-area)]/24 text-neutral-900 border border-[var(--color-focus-area)]/45',
  ENTERPRISE: 'bg-primary/20 text-neutral-900 border border-primary/35',
  // legacy labels
